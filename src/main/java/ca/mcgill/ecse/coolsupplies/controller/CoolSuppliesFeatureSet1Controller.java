...
public class CoolSuppliesFeatureSet1Controller {
  ...
  /**
   * This method updates a Parent entity with the given values for its attributes (password, name
   * and phone number).
   * 
   * @author Lune Letailleur
   * @param email: a string with the parent's email
  ...
  /**
   * This method iterates through the list of parent entities, adds them to a list of transfer
   * objects and returns that list.
   * 
   * @author Lune Letailleur
