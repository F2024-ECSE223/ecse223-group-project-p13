...
public class CoolSuppliesFeatureSet2Controller {
   ...
   * @return string: explication of the error if the student could not be added or empty string if
   ...
   * @return string: explication of the error if the student could not be updtated of an empty
   *         string if the student was updated successfully This method attempts to modify the name
   ...
   * @return string: explication of the error if the student could not be deleted or empty string if
   ...
   * @return TOStudent: an object containing the student's name and grade level or null if the
   *         student could not be retrieved This method retrieves a student based on the student's
   *         name
   */
  ...
  /**
   * @author Clara Dupuis
   * @return List<TOStudent>: a list of TOStudent objects representing all students in the
   *         CoolSupplies system This method retrieves a list of all students currently managed by
   *         the CoolSupplies application by iterating through each Student object and calling
   *         getStudent() to retrieve the corresponding TOStudent object.
   */
